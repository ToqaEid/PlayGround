...
<!--
    Document   : chatStyle.xsl
    Created on : February 13, 2017, 7:31 AM
    Author     : Israa
    Description:
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/chat">
        <html>
            ...
            <head>
                <title>
                    <xsl:value-of select="users/otherClient/userName"/> chat</title>
            </head>
            <body>
                <div class="menu">
                    <div class="back">
                       
                        <img src="logo7.png" draggable="false"/>
                    </div>
                    <div class="name">
                        <xsl:value-of select="users/otherClient/email"/>
                    </div>
                    
                </div>
                <ol class="chat">
                    
                    <xsl:variable name="creator" select="users/chatCreatorClient/email"/>
                    <xsl:for-each select="//messages/msg">
                     
                        <xsl:variable name="sender" select="from"/>
                        
                        
                        <xsl:choose>
                           
                            <xsl:when test="$sender = $creator">
                                <li class="self">
                                    <div class="avatar">
                                        <img src="me.png" draggable="false"/>
                                    </div>
                                    <div class="msg">
                                        <p> 
                                            <strong> 
